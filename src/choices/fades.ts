import { CompanionInputFieldDropdown, CompanionInputFieldNumber, CompanionOptionValues } from '@companion-module/base'

export const FadeDurationChoice: [CompanionInputFieldNumber, CompanionInputFieldDropdown, CompanionInputFieldDropdown] =
	[
		{
			type: 'number',
